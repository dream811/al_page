              ...
              <div class="row ">
                ...
                <div class="col-3 form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="fromDate" id="fromDate" placeholder="fromDate" aria-label="fromDate" aria-describedby="basic-addon1">
                    <input type="text" class="form-control form-control-sm" name="toDate" id="toDate" placeholder="toDate" aria-label="toDate" aria-describedby="basic-addon1">
                  </div>
                </div>
                <div class="col form-group">
                  <div class="input-group">
