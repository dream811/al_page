...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
	  ...
	  <li class="nav-item">
		<a class="nav-link" href="{{route('user.betLimit')}}">
	  ...
	  <li class="nav-item">
		...
		<div class="collapse" id="user-pages">
			<ul class="nav flex-column sub-menu">
				...
				<li class="nav-item"> <a class="nav-link" href="{{ route('user.ruser.transactions') }}"> 지급내역 </a></li>
			</ul>
		</div>
	  </li>
	  <li class="nav-item">
		...
		<div class="collapse" id="agent-pages">
			<ul class="nav flex-column sub-menu">
				...
				{{-- <li class="nav-item"> <a class="nav-link" href="{{ route('user.agent.paymentHistory') }}"> 지급내역 </a></li> --}}
			</ul>
		</div>
	  </li>
	  <li class="nav-item">
