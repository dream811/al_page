                ...
                <div class="card card-primary card-outline card-tabs">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <input type="text" class="form-control form-control-sm" id="strID" name="strID" value="{{ $user->strID }}" placeholder="Please input a unique id" @if ($userId > 0) readonly @endif autocomplete="off">
                            </div>
                        </div>
