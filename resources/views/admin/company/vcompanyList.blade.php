...
@push('page_scripts')
    <script>
        ...
        var table = $('#Table').DataTable({
            ...
            pageLength: 100,
            ajax: {
                url: "{{ route('admin.company.vcompanies') }}",
                // data: function ( d ) {
            ...
            columns: [
                ...
                {title: "이름", data: 'name', name: 'name', className: "text-center"},
                {title: "키", data: 'key', name: 'key', className: "text-center"},
                {title: "운영상태", data: 'maintenance', name: 'maintenance', className: "text-center",
                    render: function (data, type, row) {
                        return data == 1 ? "점검":"운영"; 
                    }
                },
                {title: "조작", data: 'id', name: 'action', className: "text-center", width: "120px",
                    render: function (data, type, row) {
